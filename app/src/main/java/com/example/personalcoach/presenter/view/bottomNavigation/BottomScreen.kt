...
import java.io.*
import com.example.personalcoach.presenter.view.bottomNavigation.setting.view.SettingScreen
import com.example.personalcoach.presenter.view.bottomNavigation.view.HomeScreen
    ...
    Scaffold(
        ...
        Column(
            ...
            when(currentNav?.destination?.route){
                ...
                settings -> SettingScreen(context)
                play -> PlayScreen()
